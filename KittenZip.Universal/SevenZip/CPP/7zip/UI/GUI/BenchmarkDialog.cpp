...
public:
  ...
  void MessageBoxError(LPCWSTR message)
  {
    ...
    MessageBoxW(*this, message, L"KittenZip", MB_ICONERROR);
    // **************** KittenZip Modification End ****************
  }
...
bool CBenchmarkDialog::OnInit()
{
...

  {
    ...
    s = "KittenZip " MILE_PROJECT_VERSION_UTF8_STRING " (" MY_CPU_NAME ")";
    // **************** KittenZip Modification End ****************
      ...
      if (res != S_OK)
      {
        if (!WasStopped_in_GUI || res != E_ABORT)
        {
          ...
          if (res == S_FALSE)
            ...
            // **************** KittenZip Modification Start ****************
            //m = "Can't find 7z.dll";
            m = "Can't find KittenZip.Core.dll";
            // **************** KittenZip Modification End ****************
          else
    ...
    const CObjectVector<CProperty> &props, UInt32 numIterations, HWND hwndParent)
{
  ...
  if (bd.TotalMode)
  {
    ...
    bd.Bench2Text = "KittenZip " MILE_PROJECT_VERSION_UTF8_STRING " (" MY_CPU_NAME ")";
    // **************** KittenZip Modification End ****************

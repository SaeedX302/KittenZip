...
static void ErrorMessage(LPCWSTR message)
{
  if (!g_DisableUserQuestions)
    ...
    MessageBoxW(NULL, message, L"KittenZip", MB_ICONERROR | MB_OK);
...
static const char* const kNoFormats = "KittenZip cannot find the code that works with archives.";
// **************** KittenZip Modification End ****************
...
static int Main2()
{
  ...
  if (commandStrings.Size() == 0)
  {
    ...
    MessageBoxW(NULL, L"Specify command", L"KittenZip", 0);
    // **************** KittenZip Modification End ****************
    return 0;
  }
  ...
  #ifdef Z7_EXTERNAL_CODECS
  {
    ...
    if (!s.IsEmpty())
    {
      if (!g_DisableUserQuestions)
        ...
        MessageBoxW(NULL, s, L"KittenZip", MB_ICONERROR);
        // **************** KittenZip Modification End ****************
    }
        ...
        || options.Command.IsFromUpdateGroup()))
  {
    ...
    if (!codecs->MainDll_ErrorPath.IsEmpty())
    {
      ...
      UString s("KittenZip cannot load module: ");
      // **************** KittenZip Modification End ****************

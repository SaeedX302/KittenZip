...
namespace KittenZip.MigrateLegacyStringResources;
...
internal class Program
{
    ...
    const string LegacyDir = $"KittenZipPackage\\{StringsDir}";
    const string NewDir = $"KittenZip.Modern\\{StringsDir}";
    ...
    static int Main(string[] args)
    {
        ...
        var project = ProjectRootElement.Open(
            $"{gitRoot}\\KittenZip.Modern\\KittenZip.Modern.vcxproj"
        );
        ...
        var filterProject = ProjectRootElement.Open(
            $"{gitRoot}\\KittenZip.Modern\\KittenZip.Modern.vcxproj.filters"
        );

/*
 * PROJECT:    KittenZip
 * FILE:       KittenZip.Codecs.Specification.Zealfs.h
...
#ifndef KittenZip_CODECS_SPECIFICATION_ZEALFS
#define KittenZip_CODECS_SPECIFICATION_ZEALFS
...
#endif // !KittenZip_CODECS_SPECIFICATION_ZEALFS

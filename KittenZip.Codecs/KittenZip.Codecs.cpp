/*
 * PROJECT:    KittenZip
 * FILE:       KittenZip.Codecs.cpp
 * PURPOSE:    Implementation for KittenZip.Codecs
 *
...
namespace
{
    ...
    {
        { "MD2", KittenZip::Codecs::Hash::CreateMd2 },
        { "MD4", KittenZip::Codecs::Hash::CreateMd4 },
        { "MD5", KittenZip::Codecs::Hash::CreateMd5 },
        { "SHA1", KittenZip::Codecs::Hash::CreateSha1 },
        { "SHA256", KittenZip::Codecs::Hash::CreateSha256 },
        { "SHA384", KittenZip::Codecs::Hash::CreateSha384 },
        { "SHA512", KittenZip::Codecs::Hash::CreateSha512 },
        { "SHA3-256", KittenZip::Codecs::Hash::CreateSha3256 },
        { "SHA3-384", KittenZip::Codecs::Hash::CreateSha3384 },
        { "SHA3-512", KittenZip::Codecs::Hash::CreateSha3512 },
        { "BLAKE3", KittenZip::Codecs::Hash::CreateBlake3 },
        { "SM3", KittenZip::Codecs::Hash::CreateSm3 },
        { "AICH", KittenZip::Codecs::Hash::CreateAich },
        { "BLAKE2b", KittenZip::Codecs::Hash::CreateBlake2b },
        { "ED2K", KittenZip::Codecs::Hash::CreateEd2k },
        { "EDON-R-224", KittenZip::Codecs::Hash::CreateEdonR224 },
        { "EDON-R-256", KittenZip::Codecs::Hash::CreateEdonR256 },
        { "EDON-R-384", KittenZip::Codecs::Hash::CreateEdonR384 },
        { "EDON-R-512", KittenZip::Codecs::Hash::CreateEdonR512 },
        { "GOST94", KittenZip::Codecs::Hash::CreateGost94 },
        { "GOST94CryptoPro", KittenZip::Codecs::Hash::CreateGost94CryptoPro },
        { "GOST12-256", KittenZip::Codecs::Hash::CreateGost12256 },
        { "GOST12-512", KittenZip::Codecs::Hash::CreateGost12512 },
        { "HAS-160", KittenZip::Codecs::Hash::CreateHas160 },
        { "RIPEMD-160", KittenZip::Codecs::Hash::CreateRipemd160 },
        { "SHA224", KittenZip::Codecs::Hash::CreateSha224 },
        { "SHA3-224", KittenZip::Codecs::Hash::CreateSha3224 },
        { "SNEFRU-128", KittenZip::Codecs::Hash::CreateSnefru128 },
        { "SNEFRU-256", KittenZip::Codecs::Hash::CreateSnefru256 },
        { "TIGER", KittenZip::Codecs::Hash::CreateTiger },
        { "TIGER2", KittenZip::Codecs::Hash::CreateTiger2 },
        { "BTIH", KittenZip::Codecs::Hash::CreateTorrent },
        { "TTH", KittenZip::Codecs::Hash::CreateTth },
        { "WHIRLPOOL", KittenZip::Codecs::Hash::CreateWhirlpool },
        { "XXH32", KittenZip::Codecs::Hash::CreateXxh32 },
        { "XXH64", KittenZip::Codecs::Hash::CreateXxh64 },
        { "XXH3_64bits", KittenZip::Codecs::Hash::CreateXxh364 },
        { "XXH3_128bits", KittenZip::Codecs::Hash::CreateXxh3128 },
    };
    ...
    {
        {
            ...
            0,
            false,
            KittenZip::Codecs::Archive::CreateUfs
        },
        {
            ...
            0,
            false,
            KittenZip::Codecs::Archive::CreateDotNetSingleFile
        },
        {
            ...
            0,
            false,
            KittenZip::Codecs::Archive::CreateElectronAsar
        },
        {
            "ROMFS",
            "romfs",
            ...
            8,
            false,
            KittenZip::Codecs::Archive::CreateRomfs
        },
        {
            "ZealFS",
            "zealfs",
            ...
            1,
            false,
            KittenZip::Codecs::Archive::CreateZealfs
        },
        {
            "WebAssembly (WASM)",
            "wasm",
            ...
            4,
            false,
            KittenZip::Codecs::Archive::CreateWebAssembly
        },
        {
            "littlefs",
            "littlefs",
            ...
            0,
            false,
            KittenZip::Codecs::Archive::CreateLittlefs
        },
    };
        ...
        _Inout_ LPPROPVARIANT Value)
    {
        ...
        case SevenZipHasherId:
        {
            Value->uhVal.QuadPart =
                KittenZip::Codecs::HashProviderIdBase | Index;
            Value->vt = VT_UI8;
            break;
        }
    ...
    _Out_ LPVOID* OutObject)
{
    ...
    if (Iid == __uuidof(IHasher))
    {
            ...
            Clsid.Data3 == SevenZipGuidData3Hasher)
        {
            ...
            if (KittenZip::Codecs::HashProviderIdBase == ProviderIdBase)
            {
    ...
    else if (Iid == __uuidof(IInArchive))
    {
            ...
            Clsid.Data3 == SevenZipGuidData3Common)
        {
            ...
            std::uint32_t ProviderIndex =
                static_cast<std::uint32_t>(ProviderId);
            if (KittenZip::Codecs::ArchiverProviderIdBase == ProviderIdBase)
            {
    ...
    _Inout_ LPPROPVARIANT Value)
{
    ...
    case SevenZipHandlerClassId:
    {
        ...
        *reinterpret_cast<PUINT64>(ClassId.Data4) =
            KittenZip::Codecs::ArchiverProviderIdBase | Index;
        Value->bstrVal = ::SysAllocStringByteLen(

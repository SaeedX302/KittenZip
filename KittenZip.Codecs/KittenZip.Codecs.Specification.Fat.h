/*
 * PROJECT:    KittenZip
 * FILE:       KittenZip.Codecs.Specification.Fat.h
...
#ifndef KittenZip_CODECS_SPECIFICATION_FAT
#define KittenZip_CODECS_SPECIFICATION_FAT
...
#endif // !KittenZip_CODECS_SPECIFICATION_FAT

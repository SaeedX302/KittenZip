/*
 * PROJECT:    KittenZip
 * FILE:       KittenZip.Codecs.MultiThreadWrapper.LZ4.cpp
...
#include "KittenZip.Codecs.MultiThreadWrapper.LZ4.h"
    ...
    _In_ UINT32 InputSize)
{
    ...
    ReadWrite.fn_read = ::KittenZipCodecsLz4Read;
    ReadWrite.fn_write = ::KittenZipCodecsLz4Write;

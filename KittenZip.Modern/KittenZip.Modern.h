 ...
 * FILE:       KittenZip.Modern.h
 * PURPOSE:    Definition for KittenZip Modern Experience
 *
...
#ifndef KittenZip_MODERN_EXPERIENCE
#define KittenZip_MODERN_EXPERIENCE

#include <Windows.h>
#include <CommCtrl.h>

/**
 * @brief Get legacy string resource from KittenZip Modern Experience resources.
...
/**
 * @brief Check whether KittenZip Modern Experience is available.
 * @return If KittenZip Modern Experience is available, it returns TRUE.
 *         Otherwise, it returns FALSE.
 */
EXTERN_C BOOL WINAPI K7ModernAvailable();

/**
 * @brief Initialize KittenZip Modern Experience.
...
/**
 * @brief Uninitialize KittenZip Modern Experience.
 * @return If the function succeeds, it returns S_OK. Otherwise, it returns an
 *         HRESULT error code.
 */
...
/**
 * @brief Show the "Sponsor KittenZip" dialog.
...
/**
 * @brief Show the "About KittenZip" dialog.
 * @param ParentWindowHandle A handle to the owner window of the dialog to be
 *                           created. If this parameter is nullptr, the dialog
 *                           has no owner window.
...
#endif // !KittenZip_MODERN_EXPERIENCE

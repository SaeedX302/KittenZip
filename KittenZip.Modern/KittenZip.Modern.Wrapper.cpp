 ...
 * FILE:       KittenZip.Modern.Wrapper.cpp
 * PURPOSE:    Implementation for KittenZip Modern Experience Wrapper
 *
...
namespace
{
    ...
    static HMODULE GetKittenZipModernModuleHandle()
    {
        static HMODULE CachedResult = ([]() -> HMODULE
        {
            ...
            ModulePath.append(L"KittenZip.Modern.dll");
    ...
    _In_ UINT32 ResourceId)
{
    ...
    {
        HMODULE ModuleHandle = ::GetKittenZipModernModuleHandle();
        if (ModuleHandle)
        {

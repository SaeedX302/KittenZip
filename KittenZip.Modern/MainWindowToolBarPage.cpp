...
namespace
{
    ...
    void UnpackagedLaunchSponsorDialog()
    {
        ...
        if (!::CreateProcessW(
            ...
            const_cast<LPWSTR>(L"KittenZip --AcquireSponsorEdition"),
            nullptr,
            nullptr,
            TRUE,
...
namespace winrt::KittenZip::Modern::implementation
{
    ...
    void MainWindowToolBarPage::InitializeComponent()
    {
        ...
        sponsorButtonLabel += Mile::WinRT::GetLocalizedString(
            L"KittenZip.Modern/MainWindowToolBarPage/SponsorButton/AcquireText",
            L"Sponsor KittenZip");
    ...
    void MainWindowToolBarPage::RefreshSponsorButtonContent()
    {
        winrt::handle(Mile::CreateThread([=]()
        {
            ...
            this->m_DispatcherQueue.TryEnqueue(
                ...
                [=]()
            {
                std::wstring ResourcePath = L"KittenZip.Modern/";
...
{
    using Interface =
        winrt::KittenZip::Modern::MainWindowToolBarPage;
    using Implementation =
        winrt::KittenZip::Modern::implementation::MainWindowToolBarPage;

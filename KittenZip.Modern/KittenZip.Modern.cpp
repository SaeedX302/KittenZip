/*
 * PROJECT:    KittenZip.Modern
 * FILE:       KittenZip.Modern.cpp
 * PURPOSE:    Implementation for KittenZip Modern Experience
 *
...
namespace
{
    static winrt::KittenZip::Modern::App g_AppInstance = nullptr;
}
...
EXTERN_C HRESULT WINAPI K7ModernInitialize()
{
    ...
    {
        // KittenZip.Modern requires resources.pri to get XAML resources.
        return E_NOINTERFACE;
    }
    try
    {
        winrt::init_apartment(winrt::apartment_type::single_threaded);
        using Implementation = winrt::KittenZip::Modern::implementation::App;
    ...
    _In_opt_ HWND ParentWindowHandle)
{
    ...
    using Interface =
        winrt::KittenZip::Modern::SponsorPage;
    using Implementation =
        winrt::KittenZip::Modern::implementation::SponsorPage;
    ...
    _In_opt_ LPCWSTR ExtendedMessage)
{
    ...
    using Interface =
        winrt::KittenZip::Modern::AboutPage;
    using Implementation =
        winrt::KittenZip::Modern::implementation::AboutPage;
    ...
    _In_opt_ LPCWSTR Content)
{
    ...
    using Interface =
        winrt::KittenZip::Modern::InformationPage;
    using Implementation =
        winrt::KittenZip::Modern::implementation::InformationPage;
    ...
    _In_ PK7_PROGRESS_WINDOW_STATUS Status)
{
    ...
    using Interface =
        winrt::KittenZip::Modern::ProgressPage;
    using Implementation =
        winrt::KittenZip::Modern::implementation::ProgressPage;
    ...
    _In_ LPVOID WindowSubclassContext)
{
    ...
    using Interface =
        winrt::KittenZip::Modern::CopyLocationPage;
    using Implementation =
        winrt::KittenZip::Modern::implementation::CopyLocationPage;

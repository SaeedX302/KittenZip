...
namespace winrt::KittenZip::Modern::implementation
{
    ...
    void AboutPage::InitializeComponent()
    {
        ...
        if (Content.empty())
        {
            Content = L"KittenZip is free software";
        }
    ...
    void AboutPage::KittenZipWebsiteButtonClick(
        ...
        winrt::RoutedEventArgs const& e)
    {
        ...
        ExecInfo.lpFile = L"https://KittenZip.org";
        ...
        winrt::RoutedEventArgs const& e)
    {
        ...
        ExecInfo.cbSize = sizeof(SHELLEXECUTEINFOW);
        ExecInfo.lpVerb = L"open";
        ExecInfo.lpFile = L"https://github.com/M2Team/KittenZip";
        ExecInfo.nShow = SW_SHOWNORMAL;
        ::ShellExecuteExW(&ExecInfo);
    }

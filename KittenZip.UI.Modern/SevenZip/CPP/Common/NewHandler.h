...
with any compiler. KittenZip's code can work with std::bad_alloc and CNewException() exceptions.
But if you use some additional code (outside of KittenZip's code), you must check

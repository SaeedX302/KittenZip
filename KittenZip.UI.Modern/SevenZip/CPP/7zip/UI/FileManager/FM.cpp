...
static const wchar_t * const kWindowClass = L"KittenZip.Modern.FileManager";
...
static BOOL InitInstance(int nCmdShow)
{
  ...
  UString title ("KittenZip"); // LangString(IDS_APP_TITLE, 0x03000000);
...
{
  MessageBoxW(0, s, L"KittenZip", MB_ICONERROR);
}
...
static int WINAPI WinMain2(int nCmdShow)
{
  ...
  */
  ...
  KittenZip::UI::SpecialCommandHandler();

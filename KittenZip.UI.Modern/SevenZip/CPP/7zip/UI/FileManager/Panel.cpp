...
#define kClassName L"KittenZip::Panel"
...
bool CPanel::OnCreate(CREATESTRUCT * /* createStruct */)
{
  ...
  */
  ...
  _addressBarControl = winrt::KittenZip::Modern::AddressBar{};
  ...
  _items =
      ...
      winrt::KittenZip::Modern::AddressBarItem>();
  ...
  _statusBarControl = winrt::KittenZip::Modern::StatusBar{};
...
void CPanel::MessageBox_Warning(LPCWSTR message) const
  { ::MessageBoxW((HWND)*this, message, L"KittenZip", MB_OK | MB_ICONWARNING); }
*/
...
void CPanel::MessageBox_Error(LPCWSTR message) const
  { MessageBox_Error_Caption(message, L"KittenZip"); }
...
void CPanel::MessageBox_Error_HRESULT(HRESULT errorCode) const
  { MessageBox_Error_HRESULT_Caption(errorCode, L"KittenZip"); }
...
void CPanel::MessageBox_LastError() const
  { MessageBox_LastError(L"KittenZip"); }
...
{
  return GetFolderTypeID().IsPrefixedBy_Ascii_NoCase("KittenZip");
}
...
void CPanel::AddToExistingArchive()
{
    ...
    // we can't use CompressFiles here, since that uses KittenZipG which doesn't
...
void CPanel::TestArchives()
{
  ...
  if (archiveFolder)
  {
    ...
    extracter.ProgressDialog.MainTitle = "KittenZip"; // LangString(IDS_APP_TITLE);

...
#include <winrt/KittenZip.Modern.h>
...
class CPanel: public NWindows::NControl::CWindow2
{
  ...
  void OnDropDownOpened(
      winrt::KittenZip::Modern::AddressBar const&,
  ...
  void OnAddressBarQuerySubmitted(
      winrt::KittenZip::Modern::AddressBar const&,
      winrt::KittenZip::Modern::AddressBarQuerySubmittedEventArgs const&);
...
public:
  ...
  */
  ...
  winrt::KittenZip::Modern::AddressBar _addressBarControl{ nullptr };
  HWND _statusBarWindow{ nullptr };
  winrt::KittenZip::Modern::StatusBar _statusBarControl{ nullptr };

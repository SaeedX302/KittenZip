...
void CPanel::OnAddressBarQuerySubmitted(
    ...
    winrt::KittenZip::Modern::AddressBarQuerySubmittedEventArgs const& queryArgs)
{
    ...
    if (chosenSuggestion)
    {
        winrt::KittenZip::Modern::AddressBarItem item
            = chosenSuggestion.as<winrt::KittenZip::Modern::AddressBarItem>();
        unsigned int index;

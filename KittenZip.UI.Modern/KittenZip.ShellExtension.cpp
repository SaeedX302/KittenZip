/*
 * PROJECT:    KittenZip
 * FILE:       KittenZip.ShellExtension.cpp
 * PURPOSE:    Implementation for KittenZip Shell Extension
 *
...
namespace
{
    ...
    static UString GetKittenZipPath()
    {
        return fs2us(NWindows::NDLL::GetModuleDirPrefix()) + L"KittenZip.Modern.FileManager.exe";
    }
}

namespace KittenZip::ShellExtension
{
    namespace CommandID
    {
        enum
...
#pragma region IExplorerCommand
            ...
            _In_opt_ IBindCtx* pbc)
        {
            ...
            case CommandID::Open:
            {
                ...
                NWindows::MyCreateProcess(::GetKittenZipPath(), params);
...
#pragma endregion
    ...
    private:
            ...
            _In_opt_ IShellItemArray* psiItemArray)
        {
            ...
            using KittenZip::ShellExtension::ExplorerCommandBase;
    ...
    _Outptr_ LPVOID* ppv)
{
    ...
    if (rclsid != __uuidof(KittenZip::ShellExtension::ClassFactory))
    {
        return E_INVALIDARG;
    }
    ...
    try
    {
        return winrt::make<KittenZip::ShellExtension::ClassFactory>(
...
// Only used in Shell Extension to check whether KittenZip Modern is loaded.

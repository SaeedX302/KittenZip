/*
 * PROJECT:    KittenZip
 * FILE:       KittenZip.UI.cpp
 * PURPOSE:    Implementation for KittenZip Modern UI Shared Infrastructures
 *
...
winrt::handle KittenZip::UI::ShowAboutDialog(
...
void KittenZip::UI::SpecialCommandHandler()
{
    std::wstring ApplicationName;
    std::map<std::wstring, std::wstring> OptionsAndParameters;
    std::wstring UnresolvedCommandLine;
